  ...
  return (
    <div className="dashboard-page page-fill">
      ...
      <div className="dashboard-overlay">
        ...
        <p className="hero-copy">Build physics and mathematics skills through short investigations. Use demonstrated skills to open tools and compatible parts, then test the build on an instrumented track. Every graph, equation, and upgrade belongs to the same car.</p>
      ...
      <div className="dashboard-rail">
        <div className="rail-card"><FlaskConical size={18} /><span>Current learning path</span><strong>{unlocked ? 'Wheel motion' : `Motion ${missionIndex + 1}/4`}</strong></div>
