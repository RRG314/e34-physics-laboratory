import { BookOpenText, CarFront, FlaskConical, Gauge, LayoutDashboard, Microscope, Network, NotebookPen, ScanLine } from 'lucide-react'
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        ...
        <div className="topbar-context"><span className="live-dot" /> 1995 525i · US · MANUAL <i /> <span>FIDELITY A</span></div>
      ...
      <footer className="app-footer"><span>MODEL HIERARCHY · ASSUMPTIONS INSPECTABLE</span><span><kbd>F</kbd> FULLSCREEN</span></footer>
    </div>
  )
}
