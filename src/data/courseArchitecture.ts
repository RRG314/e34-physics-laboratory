...
export const vehicleProgression = [
  ...
  { year: 'College · Year 1', model: '530i', system: 'Badge across engine eras', learning: 'Model identity, versioned evidence, fluid/thermal systems, and why a badge alone cannot identify a physical model.', reason: 'E34 530i history includes an initial six-cylinder and a later V8; provenance becomes part of the physics.' },
  { year: 'College · Year 2', model: '535i', system: 'Large inline-six drivetrain', learning: 'Torque curves, gearing, road load, brake work, traction limits, and multivariable experiments.', reason: 'Raises drivetrain demand while retaining an interpretable inline-six architecture.' },
